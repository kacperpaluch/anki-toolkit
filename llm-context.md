...
ai_generator/__init__.py        ← re-eksport: on_editor_buttons_init, add_to_context_menu
    ...
    └── browser_ui.py           ← add_to_context_menu (workflowy z get_workflows; submenu "Generuj pola ▸"/"Generuj zablokowane ▸" gated przez context_menu; batch AI równoległy + batch workflow _on_workflow_browser (też równoległy, semafor :free); zapis przez CollectionOp)
