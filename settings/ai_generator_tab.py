...
class AIGeneratorTab(QWidget):
    ...
    def _build_providers_page(self, ai: dict) -> QWidget:
        ...
        # Szerokość pod najdłuższą etykietę („✓ Claude CLI (subskrypcja)”), bez paska poziomego.
        self._prov_list.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self._prov_list.setFixedWidth(max(150, self._prov_list.sizeHintForColumn(0)
                                          + 2 * self._prov_list.frameWidth() + 24))
