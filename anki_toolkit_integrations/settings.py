...
class Settings(QDialog):
 def __init__(self):
  ...
  ai.addRow('Tag wszystkich kart:', self.tag)
  ai.addRow('Tag niepewnych:', self.review_tag)
  ai.addRow('Pole polskie:', self.pl)
  ai.addRow('Pole definicji:', self.definition)
  ai.addRow('Pole przykładu:', self.example)
  box.addLayout(ai)
  note = QLabel('Pole angielskie to „Pole notatki” powyżej. Tagi rozdzielaj spacją lub przecinkiem.')
